...
public class BControllerSpec : MonoBehaviour
{
    #region Declaration
                ...
                if (CheckerScript.clickedCollor == 0)
                {
                    ...
                    if (CheckerScript.WhiteHaveEat.Count == 0)
                    {
                        if ((deltaX == 1 || deltaX == -1) && deltaY == 1)
                        {
                            ...
                            if (CheckerScript.ClickedChecker.transform.position.y == 7)
                            {
                                CheckerScript.ClickedChecker.transform.localScale = new Vector3(0.2f, 0.2f, 0.1f);
                            }
                    ...
                    if ((deltaX == 2 || deltaX == -2) && (deltaY == 2 || deltaY == -2))
                    {
                        ...
                        for (int i = 0; i < 12; i++)
                        {
                                ...
                                && CheckerScript.ClickedChecker.transform.position.y + mousePosY == CheckerScript.BlackCheckers[i].transform.position.y)
                            {
                                ...
                                if (CheckerScript.ClickedChecker.transform.position.y == 7)
                                {
                                    CheckerScript.ClickedChecker.localScale = new Vector3(0.2f, 0.2f, 0.1f);
                                    int okOrNot = 0;
                                    int eat = 0;
                                    float dx = 1;
                                    ...
                                    while (dx != 8)
                                    {
                                        if (okOrNot != 1 && eat == 0)
                                        {
                                            ...
                                            for (int k = 0; k < 12; k++)
                                            {
                                                if (CheckerScript.ClickedChecker.transform.position.x + dx * mousePosX == CheckerScript.WhiteCheckers[k].transform.position.x
                                                    && CheckerScript.ClickedChecker.transform.position.y - dx * mousePosY == CheckerScript.WhiteCheckers[k].transform.position.y)
                                                {
                                                    okOrNot++;
                                                    break;
                                                }

                                                if (CheckerScript.ClickedChecker.transform.position.x + dx * mousePosX == CheckerScript.BlackCheckers[k].transform.position.x
                                                    && CheckerScript.ClickedChecker.transform.position.y - dx * mousePosY == CheckerScript.BlackCheckers[k].transform.position.y
                                                    && CheckerScript.BlackCheckers[k].transform.position.x + mousePosX != -1 && CheckerScript.BlackCheckers[k].transform.position.x + mousePosX != 8
                                                    && CheckerScript.BlackCheckers[k].transform.position.y - mousePosY != -1 && CheckerScript.BlackCheckers[k].transform.position.y - mousePosY != 8)
                                                {
                                                    eat++;
                                                    for (int j = 0; j < 12; j++)
                                                    {
                                                        if (CheckerScript.BlackCheckers[k].transform.position.x + mousePosX == CheckerScript.BlackCheckers[j].transform.position.x
                                                            && CheckerScript.BlackCheckers[k].transform.position.y - mousePosY == CheckerScript.BlackCheckers[j].transform.position.y
                                                            || CheckerScript.BlackCheckers[k].transform.position.x + mousePosX == CheckerScript.WhiteCheckers[j].transform.position.x
                                                            && CheckerScript.BlackCheckers[k].transform.position.y - mousePosY == CheckerScript.WhiteCheckers[j].transform.position.y)
                                                        {
                                                            eat--;
                                                            okOrNot++;
                                                            k = 12;
                ...
                else
                {
                    ...
                    if (CheckerScript.BlackHaveEat.Count == 0)
                    {
                        if ((deltaX == 1 || deltaX == -1) && deltaY == -1)
                        {
                            ...
                            CheckerScript.ClickedChecker.transform.Translate(new Vector3(deltaX, deltaY));
                            if (CheckerScript.ClickedChecker.transform.position.y == 0)
                            {
                                CheckerScript.ClickedChecker.localScale = new Vector3(0.2f, 0.2f, 0.1f);
                            }
                            //GameObject.Find("Camera").GetComponent<Transform>().transform.Rotate(new Vector3(0, 0, 180));
                                    ...
                                    while (dx != 8)
                                    {
                                        if (okOrNot != 1 && eat == 0)
                                        {
                                            ...
                                            for (int k = 0; k < 12; k++)
                                            {
                                                ...
                                                if (CheckerScript.ClickedChecker.transform.position.x + dx * mousePosX == CheckerScript.WhiteCheckers[k].transform.position.x
                                                    && CheckerScript.ClickedChecker.transform.position.y - dx * mousePosY == CheckerScript.WhiteCheckers[k].transform.position.y
                                                    && CheckerScript.WhiteCheckers[k].transform.position.x + mousePosX != -1 && CheckerScript.WhiteCheckers[k].transform.position.x + mousePosX != 8
                                                    && CheckerScript.WhiteCheckers[k].transform.position.y - mousePosY != -1 && CheckerScript.WhiteCheckers[k].transform.position.y - mousePosY != 8)
                                                {
                                                    eat++;
                                                    for (int j = 0; j < 12; j++)
                                                    {
                                                        if (CheckerScript.WhiteCheckers[k].transform.position.x + mousePosX == CheckerScript.BlackCheckers[j].transform.position.x
                                                            && CheckerScript.WhiteCheckers[k].transform.position.y - mousePosY == CheckerScript.BlackCheckers[j].transform.position.y
                                                            || CheckerScript.WhiteCheckers[k].transform.position.x + mousePosX == CheckerScript.WhiteCheckers[j].transform.position.x
                                                            && CheckerScript.WhiteCheckers[k].transform.position.y - mousePosY == CheckerScript.WhiteCheckers[j].transform.position.y)
                                                        {
                                                            eat--;
                                                            okOrNot++;
                                                            k = 12;
